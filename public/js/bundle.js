...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hyZXlhbnNoamhhIiwiYSI6ImNtanZmczYyMTJ6bDgzZnNlMHVkbzNycHgifQ.9lVoHjdZc_AEcGnzU1FWeg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/shreyanshjha/cmjvgh02400nh01qq60w36pxl',
    scrollZoom: false
...
function _updateSettings() {
  _updateSettings = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
